        ...
        <CardText>
          <Card style={{marginBottom: "5%"}}>
            ...
            <div style={{overflow: 'hidden', marginLeft: "2%"}}>
              <p>1/5</p><br/>
              <p>実験を始める前に、ブラウザを全画面表示にしてください</p>
            </div>
            ...
            <div style={{overflow: 'hidden' ,marginLeft: "2%"}}>
              <p>3/5</p><br/>
              <p>(1)6つのボタンをクリックしまくって最高点数を目指す。<br /><br />・ここでは、Aグループのボタン３つとBグループのボタン３つの合計６つのボタンが登場します。<br />・６つのボタンにはそれぞれにポイントが割り振られており、クリックすることでポイントを獲得できます。<br />・なお、１回の挑戦につき、AグループとBグループのそれぞれ１つずつボタンをクリックできます。<br />・クリックした２種類のボタンのポイントを合計したものがあなたの獲得ポイントです。<br /><br />・どのボタンがどれくらい獲得ポイントに影響を与えるか考えながらゲームを進めてください。<font color='#ff0000'>(メモをとってもかまいません)</font>
              </p>
            </div>
